...
export default async function CoreHomePage() {
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-4.5rem)] max-w-5xl flex-col gap-8 p-6 sm:p-10">
      ...
      <section className="space-y-4 rounded border border-zinc-200 bg-white/80 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h2 className="text-lg font-semibold">Storages</h2>
            <p className="text-sm text-zinc-600">
              Fetched via <code>/storages</code>.
            </p>
          </div>
          <Link
            href="/openapi"
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-zinc-500">
                    Provider: {storage.provider} • Updated{" "}
